...
public class checkProcess {
    public static String check(String path, HttpServletRequest request, HttpServletResponse response,List<String> mydate)
            throws Exception {
        try {
            String myresult="";
           ...
           // System.out.println(data);
            if ("".equals(data)) {
                ...
                if (data.indexOf("MACAddress") == -1 || data.indexOf("IdentificationCode") == -1) {
                    ...
                    //EnterpriseName=�����ӽ�;MACAddress=78-2B-CB-6E-DE-9F;TimeEnd=3755260800000;IdentificationCode=TongWaveBPM78-2B-CB-6E-DE-9F
                    //EnterpriseName=ͬ΢����Ƽ����޹�˾;MACAddress=FA-16-3E-BF-C9-BB;TimeEnd=4083840000000;IdentificationCode=TongWaveBPMFA-16-3E-BF-C9-BB
                    if(data.indexOf("EnterpriseName") != -1 && data.indexOf("MACAddress") != -1 &&
                     ...
                     //   System.out.println("lic mac："+MACAddress);
                        if(checkMac(getMac.getLocalMac(ia),MACAddress)){
                            result.add("1");
                        }
    ...
    public static boolean checkMac(String LocalMac,String MACAddress){
        Boolean flag=false;
        String[] split = MACAddress.split(",");
        for(String s: split){
            if(s.equals(LocalMac)){
                flag=true;
                break;
            }
        }
