                  ...
                  if ("SequenceFlow" == stencil_id) {
                     ...
                     /* else if(flowElement.properties.usertaskassignment=='' ||flowElement.properties.huiqian=='' ){
                      ...
                      //会签节点
                          ...
                          //新增替换josn中的huiqianTemp，huiqianType，用$rootScope.modelData.model.childShapes总的值
                      ...
                      //单任务节点
                          ...
                          //因为设置的是角色，要把办理人与角色相互换
                        /*  if(flowElement.properties.usertaskassignment!=''){
                                if(flowElement.properties.usertaskassignment.assignment!=''&&flowElement.properties.usertaskassignment.assignment!=undefined){
                                    if(flowElement.properties.usertaskassignment.assignment.assigneType!=undefined&&
                                        flowElement.properties.usertaskassignment.assignment.assigneTemp!=undefined){
                                        if(flowElement.properties.usertaskassignment.assignment.assigneType=='1'){
                                           var temp= flowElement.properties.usertaskassignment.assignment.assignee;
                                            flowElement.properties.usertaskassignment.assignment.assignee=
                                                flowElement.properties.usertaskassignment.assignment.assigneTemp;
                                            flowElement.properties.usertaskassignment.assignment.assigneTemp=temp;
                                        }
                                    }
                                }
                          }*/
...
function get_rootScope_modelData_model_childShapes_properties(resourceId,modelData) {
    var data;
    for(var nn=0;nn<modelData.length;nn++){
        if(resourceId==modelData[nn].resourceId){
            data=modelData[nn].properties;
            break;
        }
    }
    return data;
