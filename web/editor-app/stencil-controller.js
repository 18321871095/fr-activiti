...
angular.module('activitiModeler')
    .controller('StencilController', ['$rootScope', '$scope', '$http', '$modal', '$timeout', function ($rootScope, $scope, $http, $modal, $timeout) {
        ...
        //http://localhost:8080/webroot/modeler.html?modelId=162505&modelerStatus=true&param=&register=false&time=54
        //http://localhost:8080/webroot/modeler.html?modelId=150003&modelerStatus=false&param=262c2a1cd5df4f078648c6d9a73cac51&width=802&height=651
        console.log("href:"+href);
        var modelerStatus=href.split("&")[1].split("=")[1];
        var myregister="";
        var mytime="";
        if(href.split("&").length>3){
            if("register"==href.split("&")[3].split("=")[0]&&"time"==href.split("&")[4].split("=")[0]){
           ...
           // console.log($scope.selectedShape)
            ...
            if(property.key=='oryx-usertaskassignment'){
               ...
               // console.log($scope.selectedItem)
                ...
                //新增会签角色选择
                if(property.huiqianType=='1'){
                    $scope.selectedShape.properties["oryx-huiqianType"]="1";
                    $scope.selectedShape.properties["oryx-huiqianTemp"]=property.huiqianTemp;
                    console.log("huiqianType1")
                }
                if(property.huiqianType=='0'){
                    $scope.selectedShape.properties["oryx-huiqianType"]="0";
                    $scope.selectedShape.properties["oryx-huiqianTemp"]=property.huiqianTemp;
